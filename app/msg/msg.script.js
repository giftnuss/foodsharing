var msg = {
	...
	init: function(){
		...
		var cid = 0;
		if($('#conversation-list ul li a').length > 0)
		{
	...
	appendMsg: function(message){
		var $el = $('<li id="msg-'+message.id+'" style="display:none;"><span class="img"><a title="'+message.fs_name+'" href="#" onclick="profile('+message.fs_id+');return false;"><img height="35" src="'+img(message.fs_photo,'mini')+'" /></a></span><span class="body">'+message.body+'<span class="time">'+timeformat.nice(message.time)+'</span></span><span class="clear"></span></li>');
