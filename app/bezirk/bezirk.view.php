...
class BezirkView extends View
{
		...
		<div class="welcome ui-padding margin-bottom ui-corner-all">
			<div class="welcome_profile_name">
				...
				<div class="welcome_quick_link">
					<ul>
						<li>'.$this->bezirk['stat_fscount'].' Foodsaver, '.$this->bezirk['stat_botcount'].' Botschafter, '.$this->bezirk['stat_betriebcount'].' Betriebe '.$this->bezirk['stat_korpcount'].' laufende Koorperationen</li>
					</ul>
					<div class="clear"></div>
				</div>
			</div>
	...
	public function thread($thread,$posts)
	{
		addHidden('
