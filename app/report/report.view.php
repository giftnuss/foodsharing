...
class ReportView extends View
{
	...
	public function reportDialog()
	{
		return v_input_wrapper('Warum möchtest Du '.$this->foodsaver['name'].' melden?', '
			...
			'.v_form_select('reportreason',array('required'=>true,'nowrapper' => true,'value' => 1,'values'=>array(
                ...
                ['id' => 3, 'name' => 'Hat sich unhöflich oder respektlos verhalten'],
                ['id' => 4, 'name' => 'Hat den Abholort nicht sauber hinterlassen'],
                ['id' => 5, 'name' => 'Hat sich nicht gemeinschaftlich und sozial beim Abholen verhalten'],
                ['id' => 6, 'name' => 'Hat sich fordernd/übergriffig verhalten'],
                ['id' => 7, 'name' => 'Hat Vorwürfe gemacht'],
                ['id' => 8, 'name' => 'Hat Sachen mitgenommen die nicht für ihn/sie bestimmt waren'],
                ...
                ['id' => 13, 'name' => 'Nimmt nicht alle zur Abholung vorgesehenen Lebensmitteln mit'],
			...
			'.v_form_select('reportreason_3_sub',array('nowrapper' => true,'value' => 1,'values'=>array(
                ...
                ['id' => 5, 'name' => 'Gewaltätigkeit und Drohung'],
    ...
    {
        return is_array($foodsaver) ? v_field($this->fsAvatarList($foodsaver, ['noshuffle' => true]), 'Alle gemeldeten Foodsaver') : null;
    }
}
