...
class ContentView extends View
{
	...
	public function ratgeber()
	{
        ...
        <ul>
        <li>Fleisch +2°C bis +7°C</li>
        <li>Geflügel &amp; Erzeugnisse daraus +2°C bis +4°C</li>
        <li>Milch &amp; Milcherzeugnisse +2°C bis +10°C</li>
        <li>Fisch, Fischereierzeugnisse +2°C</li>
        <li>Fischereierzeugnisse vakuumverpackt +2°C bis +7°C</li>
        <li>Eier (ab 1. Tag nach dem Legen) (siehe empfindliche Lebensmittel „Eier“ )</li>
        <li>Flüssigei, Eiprodukte +4°C</li>
        <li>Roheihaltige Lebensmittel +2°C bis +7°C</li>
        <li>Speiseeis in Fertigpackungen -18°C</li>
        <li>Backwaren mit nicht durcherhitzter Füllung +7°C</li>
        <li>Feinkost-, Rohkost- &amp; Kartoffelsalate +2°C bis +7°C</li>
        <li>Marinaden und Mayonnaisen +2°C bis +7°C</li>
        </ul>
        ...
        <p>Bei der Feststellung von sensorischen Abweichungen der Lebensmittel, die angeboten werden, sollten diese als Information mit angegeben werden. Das könnte z. B. heißen, dass sie nicht mehr richtig knackig sind oder verblassen. Um möglichst lang frische Lebensmittel genießen zu können und eine unsachgemäße Lagerung der Lebensmittel zu vermeiden, wird hier auf den Punkt Kühlkette/Temperaturzonen verwiesen.</p>
