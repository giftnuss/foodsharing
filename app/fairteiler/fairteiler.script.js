$(function(){
	$("#wallpost-attach-image").before('<label style="margin:0 15px 0 0;padding:0;cursor:pointer;"><img style="margin:0;padding:0;position:relative;top:10px;" src="img/facebook_share.png" alt="Auf Facebook teilen" /><input style="position:relative;top:3px;" type="checkbox" name="fbshare" id="fbshare" value="1" /></label>');
