...
function enableDesignMode(textarea){var iframe=document.createElement("iframe");iframe.frameBorder=0;iframe.frameMargin=0;iframe.framePadding=0;iframe.height=50;if(textarea.attr('class'))
...
function toolbar(iframe){var tb=$("<div class='rte-toolbar' id='toolbar-"+iframe.title+"'><div>\
           <!-- <p>\
            ...
            <p>\
                <a href='#' class='bold'><span>&nbsp;</span></a>\
                <a href='#' class='italic'><span>&nbsp;</span></a>\
                <a href='#' class='unorderedlist'><span>&nbsp;</span></a>\
                <a href='#' class='link'><span>&nbsp;</span></a>\
            </p>\
            <!--<p>\
                <a href='#' class='image'><span>&nbsp;</span></a>\
                <a href='#' class='disable'><span>&nbsp;</span></a>\
            </p>--><div style='clear:both'></div></div></div>");$('select',tb).change(function(){var index=this.selectedIndex;if(index!=0){var selected=this.options[index].value;formatText(iframe,"formatblock",'<'+selected+'>');}});$('.bold',tb).click(function(){formatText(iframe,'bold');return false;});$('.italic',tb).click(function(){formatText(iframe,'italic');return false;});$('.unorderedlist',tb).click(function(){formatText(iframe,'insertunorderedlist');return false;});$('.link',tb).click(function(){var p=prompt("URL:");if(p)
