REPLACE INTO `fs_conversation` (`id`, `locked`, `name`, `start`, `last`, `last_foodsaver_id`, `start_foodsaver_id`, `last_message_id`, `last_message`, `member`) VALUES ('1', '1', 'betrieb bla', NULL, NULL, NULL, NULL, NULL, '', ''), ('2', '1', 'springer bla', NULL, NULL, NULL, NULL, NULL, '', '');
REPLACE INTO `fs_abholer` (`foodsaver_id`, `betrieb_id`, `date`, `confirmed`) VALUES
...
REPLACE INTO `fs_betrieb_team` (`foodsaver_id`, `betrieb_id`, `verantwortlich`, `active`, `stat_last_update`, `stat_fetchcount`, `stat_first_fetch`, `stat_last_fetch`, `stat_add_date`) VALUES
