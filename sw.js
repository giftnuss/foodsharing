var serviceWorkerOption = {
  "assets": [
    "/81a5ea609d71905f8589.hot-update.json",
    "/fonts/fa-brands-400.eot",
    "/img/fa-brands-400.svg",
    "/fonts/fa-brands-400.ttf",
    "/fonts/fa-brands-400.woff",
    "/fonts/fa-brands-400.woff2",
    "/fonts/fa-regular-400.eot",
    "/img/fa-regular-400.svg",
    "/fonts/fa-regular-400.ttf",
    "/fonts/fa-regular-400.woff",
    "/fonts/fa-regular-400.woff2",
    "/fonts/fa-solid-900.eot",
    "/img/fa-solid-900.svg",
    "/fonts/fa-solid-900.ttf",
    "/fonts/fa-solid-900.woff",
    "/fonts/fa-solid-900.woff2",
    "/img/markers-soft.png",
    "/img/markers-soft@2x.png",
    "/fonts/alfa-slab-one-latin-400.woff",
    "/fonts/alfa-slab-one-latin-400.woff2",
    "/js/Modules/Application.js",
    "/js/31da7c6ed60142d88388.js",
    "/js/Modules/Basket.js",
    "/js/Modules/Blog.js",
    "/js/Modules/BusinessCard.js",
    "/js/Modules/Content.js",
    "/js/63377af6a039fa9fddc8.js",
    "/js/Modules/Dashboard.js",
    "/js/Modules/Email.js",
    "/js/f024858a19e302322a4d.js",
    "/js/Modules/Event.js",
    "/js/Modules/FAQAdmin.js",
    "/js/Modules/FAQList.js",
    "/js/Modules/FairTeiler.js",
    "/js/Modules/Foodsaver.js",
    "/js/Modules/Index.js",
    "/js/Modules/Legal.js",
    "/js/Modules/Login.js",
    ...
    "/js/Modules/PassportGenerator.js",
    "/js/Modules/Profile.js",
    "/js/Modules/Quiz.js",
    "/js/Modules/Region.js",
    "/js/Modules/RegionAdmin.js",
    "/js/Modules/Relogin.js",
    "/js/Modules/Report.js",
    "/js/Modules/Settings.js",
    "/js/Modules/Statistics.js",
    "/js/Modules/Store.js",
    "/js/Modules/StoreUser.js",
    "/js/Modules/Team.js",
    "/js/Modules/WorkGroup.js",
    "/js/b6f2a29fe1bef56b28ba.js",
    "/js/207e1035da78784581cc.js",
    "/js/70de40f133ed420fbef7.js",
    "/js/103f7a3a9c69ec542c15.js",
    "/js/819aeac19242a378cdb4.js",
    "/js/9da88af0131b7fc7b2b7.js",
    "/js/2b24fb081e7e4c8280c3.js",
    "/901beacc2ae2b5da7512.hot-update.json"
  ]
};
...
/******/ 	var hotCurrentHash = "29659a13531b55ee2456";
...
/******/ 	return hotCreateRequire("./src/serviceWorker.js")(__webpack_require__.s = "./src/serviceWorker.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("\n\n__webpack_require__(/*! core-js/modules/es6.string.iterator */ \"./node_modules/core-js/modules/es6.string.iterator.js\");\n\n__webpack_require__(/*! core-js/modules/es6.array.from */ \"./node_modules/core-js/modules/es6.array.from.js\");\n\n__webpack_require__(/*! core-js/modules/es6.regexp.to-string */ \"./node_modules/core-js/modules/es6.regexp.to-string.js\");\n\n__webpack_require__(/*! core-js/modules/es6.object.to-string */ \"./node_modules/core-js/modules/es6.object.to-string.js\");\n\n__webpack_require__(/*! core-js/modules/es7.symbol.async-iterator */ \"./node_modules/core-js/modules/es7.symbol.async-iterator.js\");\n\n__webpack_require__(/*! core-js/modules/es6.symbol */ \"./node_modules/core-js/modules/es6.symbol.js\");\n\n__webpack_require__(/*! core-js/modules/web.dom.iterable */ \"./node_modules/core-js/modules/web.dom.iterable.js\");\n\nvar _urls = _interopRequireDefault(__webpack_require__(/*! @/urls */ \"./src/urls.js\"));\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _nonIterableSpread(); }\n\nfunction _nonIterableSpread() { throw new TypeError(\"Invalid attempt to spread non-iterable instance\"); }\n\nfunction _iterableToArray(iter) { if (Symbol.iterator in Object(iter) || Object.prototype.toString.call(iter) === \"[object Arguments]\") return Array.from(iter); }\n\nfunction _arrayWithoutHoles(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = new Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } }\n\nself.addEventListener('push', function (event) {\n  if (!(self.Notification && self.Notification.permission === 'granted')) {\n    return;\n  }\n\n  var sendNotification = function sendNotification(title, options) {\n    return self.registration.showNotification(title, options);\n  };\n\n  if (event.data) {\n    var data = event.data.json();\n    event.waitUntil(sendNotification(data.title, data.options));\n  }\n});\nself.addEventListener('notificationclick', function (event) {\n  if (event.notification.data.action) {\n    var page = event.notification.data.action.page;\n    var params = event.notification.data.action.params;\n\n    var url = _urls.default[page].apply(_urls.default, _toConsumableArray(params));\n\n    self.clients.openWindow(url);\n  }\n}); // Ensure new workers to replace old ones...\n// https://developer.mozilla.org/en-US/docs/Web/API/ServiceWorkerGlobalScope/skipWaiting\n\nself.addEventListener('install', function (event) {\n  event.waitUntil(self.skipWaiting());\n});\nself.addEventListener('activate', function (event) {\n  event.waitUntil(self.clients.claim());\n});//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./src/serviceWorker.js\n");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n// these are used for generating link-paths inside vue\n// e.g. $url('profile', 15)\nvar _default = {\n  profile: function profile(id) {\n    return \"/profile/\".concat(id);\n  },\n  store: function store(id) {\n    return \"/?page=betrieb&id=\".concat(id);\n  },\n  forum: function forum(regionId) {\n    var regionSubId = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;\n    return \"/?page=bezirk&bid=\".concat(regionId, \"&sub=\").concat(regionSubId === 1 ? 'botforum' : 'forum');\n  },\n  fairteiler: function fairteiler(regionId) {\n    return \"/?page=bezirk&bid=\".concat(regionId, \"&sub=fairteiler\");\n  },\n  members: function members(regionId) {\n    return \"/?page=bezirk&bid=\".concat(regionId, \"&sub=members\");\n  },\n  statistic: function statistic(regionId) {\n    return \"/?page=bezirk&bid=\".concat(regionId, \"&sub=statistic\");\n  },\n  events: function events(regionId) {\n    return \"/?page=bezirk&bid=\".concat(regionId, \"&sub=events\");\n  },\n  stores: function stores(regionId) {\n    return \"/?page=betrieb&bid=\".concat(regionId);\n  },\n  storeAdd: function storeAdd() {\n    var regionId = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;\n    return regionId ? \"/?page=betrieb&a=new&bid=\".concat(regionId) : \"/?page=betrieb&a=new\";\n  },\n  workingGroups: function workingGroups() {\n    var regionId = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;\n    return regionId ? \"/?page=groups&p=\".concat(regionId) : \"/?page=groups\";\n  },\n  workingGroupEdit: function workingGroupEdit(groupId) {\n    return \"/?page=groups&sub=edit&id=\".concat(groupId);\n  },\n  wall: function wall(regionId) {\n    return \"/?page=bezirk&bid=\".concat(regionId, \"&sub=wall\");\n  },\n  foodsaverList: function foodsaverList(regionId) {\n    return \"/?page=foodsaver&bid=\".concat(regionId);\n  },\n  passports: function passports(regionId) {\n    return \"/?page=passgen&bid=\".concat(regionId);\n  },\n  conversations: function conversations() {\n    var conversationId = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;\n    return \"/?page=msg\".concat(conversationId ? \"&cid=\".concat(conversationId) : '');\n  },\n  dashboard: function dashboard() {\n    return \"/?page=dashboard\";\n  },\n  map: function map() {\n    return \"/karte\";\n  },\n  home: function home() {\n    return \"/\";\n  },\n  mailbox: function mailbox() {\n    return \"/?page=mailbox\";\n  },\n  settings: function settings() {\n    return \"/?page=settings\";\n  },\n  logout: function logout() {\n    return \"/?page=logout\";\n  },\n  joininfo: function joininfo() {\n    return \"/?page=content&sub=joininfo\";\n  },\n  basket: function basket(basketId) {\n    return \"/essenskoerbe/\".concat(basketId);\n  },\n  baskets: function baskets() {\n    return \"/essenskoerbe\";\n  },\n  upgradeToFs: function upgradeToFs() {\n    return \"/?page=settings&sub=upgrade/up_fs\";\n  },\n  mission: function mission() {\n    return \"/ueber-uns\";\n  },\n  claims: function claims() {\n    return \"/?page=content&sub=forderungen\";\n  },\n  fasten: function fasten() {\n    return \"/?page=content&sub=fasten\";\n  },\n  leeretonne: function leeretonne() {\n    return \"/?page=content&sub=leeretonne\";\n  },\n  academy: function academy() {\n    return \"/?page=content&sub=academy\";\n  },\n  workshops: function workshops() {\n    return \"/?page=content&sub=workshops\";\n  },\n  festival: function festival() {\n    return \"/?page=content&sub=festival\";\n  },\n  international: function international() {\n    return \"/?page=content&sub=international\";\n  },\n  transparency: function transparency() {\n    return \"/?page=content&sub=transparency\";\n  },\n  contact: function contact() {\n    return \"/?page=content&sub=contact\";\n  },\n  dataprivacy: function dataprivacy() {\n    return \"/?page=legal\";\n  },\n  partner: function partner() {\n    return \"/partner\";\n  },\n  statistics: function statistics() {\n    return \"/statistik\";\n  },\n  infosCompany: function infosCompany() {\n    return \"/fuer-unternehmen\";\n  },\n  infos: function infos() {\n    return \"/?page=content&sub=infohub\";\n  },\n  blog: function blog() {\n    return \"/news\";\n  },\n  faq: function faq() {\n    return \"/faq\";\n  },\n  guide: function guide() {\n    return \"/ratgeber\";\n  },\n  wiki: function wiki() {\n    return \"https://wiki.foodsharing.de/\";\n  },\n  grundsaetze: function grundsaetze() {\n    return \"https://wiki.foodsharing.de/Grunds\\xE4tze\";\n  },\n  communitiesGermany: function communitiesGermany() {\n    return \"/?page=content&sub=communitiesGermany\";\n  },\n  communitiesAustria: function communitiesAustria() {\n    return \"/?page=content&sub=communitiesAustria\";\n  },\n  communitiesSwitzerland: function communitiesSwitzerland() {\n    return \"/?page=content&sub=communitiesSwitzerland\";\n  },\n  team: function team() {\n    return \"/team\";\n  },\n  press: function press() {\n    return \"/?page=content&sub=presse\";\n  },\n  imprint: function imprint() {\n    return \"/impressum\";\n  },\n  donate: function donate() {\n    return \"/unterstuetzung\";\n  },\n  changelog: function changelog() {\n    return \"/?page=content&sub=changelog\";\n  }\n};\nexports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./src/urls.js\n");
