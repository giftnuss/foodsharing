...
class SettingsControl extends Control
{
	...
	public function info()
	{
		...
		if (isset($_POST['form_submit']) && $_POST['form_submit'] == 'settingsinfo') {
			...
			$unfollow_fair_share_point = array();
			...
			if (!empty($unfollow_fair_share_point)) {
				$this->model->unfollowFairteiler($unfollow_fair_share_point);
			}
		...
		$foodSharePoint = $this->model->getFairteiler();
