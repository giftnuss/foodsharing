					...
					<div class="ui-dialog-content ui-widget-content">
						<div id="map-control">
							<ul class="linklist">
								...
								<li><a name="communities" class="ui-corner-all communities"><span class="fa-stack fa-lg" style="color: cornflowerblue"><i class="fas fa-circle fa-stack-2x"></i><i class="fas fa-users fa-stack-1x fa-inverse"></i></span><span>Ortsgruppen</span></a></li>
							</ul>
						</div>
					</div>
				</div>
