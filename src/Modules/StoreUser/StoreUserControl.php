...
');
			...
			$region = $this->regionGateway->getRegion($this->session->getCurrentBezirkId());
			$stores = $this->storeGateway->getMyStores($this->session->id(), $this->session->getCurrentBezirkId());
