...
class ContentView extends View
{
	...
	public function joininfo()
	{
		...
		<div class="page ui-padding ui-widget-content corner-all">
			...
			<p>Wenn ihr Lebensmittel übergeben oder übernehmen wollt, seid bitte zuverlässig und pünktlich, lasst keinen im „Regen“ stehen.</p>
			<h5><span>5</span> Mach Vorschläge</h5>
			<p>Wir wollen uns weiterentwickeln, immer besser werden. Dazu brauchen wir Euch mit vielen guten Ideen und Tipps. Die schickt Ihr an <a href="mailto:ideen@foodsharing.network">ideen@foodsharing.network</a></p>
	...
	public function ratgeber()
	{
        ...
        <h4>Fisch</h4>
        <p>Fisch ist eines der Lebensmittel, welches von den Konsumenten eine immer höhere Wertschätzung bekommt. Er enthält Jod, Vitamin D, wichtige Omega 3 – Fettsäuren, sowie hochwertiges Eiweiß. Man bekommt Fisch in den Angebotsformen Frischfisch, Tiefgefroren, in Konserven, Geräuchert oder als Fischereierzeugnisse in der Kühlung. Beim Einkauf von Frischfisch sollte man allerdings auf folgende Qualitätskriterien achten:</p>
        <ul>
