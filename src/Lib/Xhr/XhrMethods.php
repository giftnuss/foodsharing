...
class XhrMethods
{
	...
	public function xhr_update_abholen($data)
	{
		...
		$bellData = BellData::create('store_cr_times_title', 'store_cr_times', 'img img-store brown', [
	...
	public function xhr_betriebRequest($data)
	{
		...
		if ($biebs = $this->storeGateway->getBiebsForStore($data['id'])) {
			...
			$bellData = BellData::create('store_new_request_title', 'store_new_request', 'img img-store brown', [
