...
$g_lang['store_info'] = 'Es sind <strong> {active} </strong> Aktive und <strong> {jumper} </strong> Springer im Team.';
$g_lang['store_info_pickupcount'] = 'Bei diesem Betrieb wurde <strong>{pickupCount}<span style="white-space:nowrap"> </span>x</strong> abgeholt.';
$g_lang['store_info_pickupweight'] = 'Es wurden <strong>{fetch_weight}<span style="white-space:nowrap"> </span>kg</strong> gerettet.</div>';
$g_lang['store_info_cooperation'] = 'Kooperation seit {startTime}.';
$g_lang['store_info_freq'] = 'Es wird in etwa {freq} abgeholt. Geh bitte niemals ohne Absprache zum Laden!</div>';
