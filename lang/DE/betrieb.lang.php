...
$g_lang['ansprechpartner'] = 'Betriebs-Ansprechpartner (Fillialleiter etc.)';
$g_lang['fax'] = 'Fax';
...
$g_lang['lebensmittel'] = 'Welche Lebensmittel dürfen abheholt werden?';
$g_lang['ueberzeugungsarbeit'] = 'War es einfach den/die Verantwortlich(en) zu überzeugen bei den LebensmittelretterInnen mitzmachen?';
$g_lang['presse'] = 'Ist der Betrieb/Laden/Verein bereit das er/sie bei der Presse und lebensmittelretten.de genannt werden darf?';
$g_lang['sticker'] = 'Ist der Betrieb/Laden/Verein etc. gewillt einen Sticker beim Eingang oder anderswo sichtbar aufzuhängen das sie keine Lebensmittel wegschmeißen und so bei foodsharing.de mitmachen?';
$g_lang['abholmenge'] = 'Wie viel Kilo werden pro Abholung ungefähr mitgenommen?';
$g_lang['besonderheiten'] = 'Besonderheiten';
$g_lang['begin'] = 'Begin der Koorperation';
