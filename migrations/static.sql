...
(9, 1, 'Neue Nachricht', '{SENDER} hat Dir eine Nachricht geschrieben', '<p>{ANREDE} {NAME},</p><p>{SENDER} hat Dir eine Nachricht geschrieben.</p><p>Klicke auf den folgenden Link, um Deine Nachricht auf der foodsharing-Plattform zu lesen.<br /> Dein foodsharing.de-Team</p><p></p><div class="border">{MESSAGE}<p><a href="{LINK}" target="_blank" class="button">Antworten</a></p></div>'),
...
REPLACE INTO `fs_bezirk` (`id`, `parent_id`, `has_children`, `type`, `teaser`, `desc`, `photo`, `master`, `mailbox_id`, `name`, `email`, `email_pass`, `email_name`, `apply_type`, `banana_count`, `fetch_count`, `week_num`, `report_num`, `stat_last_update`, `stat_fetchweight`, `stat_fetchcount`, `stat_postcount`, `stat_betriebcount`, `stat_korpcount`, `stat_botcount`, `stat_fscount`, `stat_fairteilercount`, `conversation_id`, `moderated`) VALUES ('1565', '0', '', '1', 'Aktive', 'Aktive', '', '0', '0', 'Aktive (Orga)', '', '', '', '2', '0', '0', '0', '', '', '', '', '', '', '', '', '', '', '0', '0');
