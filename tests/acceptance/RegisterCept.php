...
$I->click('Mach-Mit!');
$I->waitForElementVisible('#joinform', 1);
$I->waitForElementVisible('#joinform .step.step0', 1);
$I->click('weiter', '.step.step0');

// fill in basic details

$I->waitForElementVisible('#joinform .step.step1', 1);
...
$I->waitForElementVisible('#joinform .step.step2', 3);
$I->click('weiter', '.step.step2');

// tick all the check boxes

$I->waitForElementVisible('#joinform .step.step3', 1);
codecept_debug($I->grabTextFrom('#joinform'));
